            ...
            <div className={nav ? classes.NavMainDivActive : classes.NavMainDiv}>
                ...
                <div className={classes.btnsHolder}>
                    ...
                    <div className={classes.langBtnHolder}>
                        {langFlag ? <button className={classes.langBtnBg} onClick={()=>changeLanguage()} type="button"></button> : <button className={classes.langBtnEn} onClick={()=>changeLanguage()} type="button"></button>}
